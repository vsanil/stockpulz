...
*Regenerated 2026-08-27 03:02 UTC by `scripts/analyze_engine.py`. Read this at the START of a session and work the open findings.*
...
### [ACT] [TECHNICAL BUG] ANET filled 2.43% outside the published entry window  *(n=59)*

`entry_window/ANET/2026-08-05` · **acknowledged**, open 4d
...
**Evidence:** The morning message promises "enter within X% — skip if above". ANET filled 2.43% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 2 of 59 observations breach (3.4%).
...
### [ACT] [TECHNICAL BUG] NWSA filled 2.15% outside the published entry window  *(n=59)*

`entry_window/NWSA/2026-08-06` · **acknowledged**, open 4d
...
**Evidence:** The morning message promises "enter within X% — skip if above". NWSA filled 2.15% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 2 of 59 observations breach (3.4%).
...
`integrity/638eb7bc69ed` · **acknowledged**, open 4d
...
`integrity/425fd0b45bd0` · **acknowledged**, open 4d
...
### [MEASURE] [METRIC] Stop distance distribution  *(n=76)*

**Evidence:** median 5.1% across 76 positions; 0 below the 3.0% threshold.
