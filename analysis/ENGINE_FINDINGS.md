...
*Regenerated 2026-09-25 00:23 UTC by `scripts/analyze_engine.py`. Read this at the START of a session and work the open findings.*
...
### [DECIDED] [TECHNICAL BUG] NVDA filled 8.98% outside the published entry window  *(n=121)*

`entry_window/NVDA/2026-08-27` · **acknowledged**, open 28d
...
**Evidence:** The morning message promises "enter within X% — skip if above". NVDA filled 8.98% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 121 observations breach (8.3%).
...
### [DECIDED] [TECHNICAL BUG] AMZN filled 4.0% outside the published entry window  *(n=121)*

`entry_window/AMZN/2026-08-28` · **acknowledged**, open 27d
...
**Evidence:** The morning message promises "enter within X% — skip if above". AMZN filled 4.0% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 121 observations breach (8.3%).

**You ruled: acknowledged.** No action is outstanding. For the record, the suggested fix was: HISTORICAL — acknowledge it; it cannot be un-made. This fill predates 2026-09-15, when the bot began both OBEYING the window (synthetic_user._entry_breach skips an out-of-window pick, and records the skip so the metric cannot go quiet) and buying punctually at 08:00 ET. Before that it bought 4-6 h late, so this fill measured its own execution lag as much as the engine's levels. Do NOT widen formatters.entry_window_pct 'to match measured reality' — proposed, investigated and rejected 2026-09-13: it would legitimise the bad fill and weaken a published promise.

</details>

### [DECIDED] [TECHNICAL BUG] NOW filled 2.68% outside the published entry window  *(n=121)*

`entry_window/NOW/2026-08-31` · **acknowledged**, open 24d
...
**Evidence:** The morning message promises "enter within X% — skip if above". NOW filled 2.68% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 121 observations breach (8.3%).

**You ruled: acknowledged.** No action is outstanding. For the record, the suggested fix was: HISTORICAL — acknowledge it; it cannot be un-made. This fill predates 2026-09-15, when the bot began both OBEYING the window (synthetic_user._entry_breach skips an out-of-window pick, and records the skip so the metric cannot go quiet) and buying punctually at 08:00 ET. Before that it bought 4-6 h late, so this fill measured its own execution lag as much as the engine's levels. Do NOT widen formatters.entry_window_pct 'to match measured reality' — proposed, investigated and rejected 2026-09-13: it would legitimise the bad fill and weaken a published promise.

</details>

### [DECIDED] [TECHNICAL BUG] MMED filled 5.74% outside the published entry window  *(n=121)*

`entry_window/MMED/2026-09-02` · **acknowledged**, open 23d
...
**Evidence:** The morning message promises "enter within X% — skip if above". MMED filled 5.74% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 121 observations breach (8.3%).

**You ruled: acknowledged.** No action is outstanding. For the record, the suggested fix was: HISTORICAL — acknowledge it; it cannot be un-made. This fill predates 2026-09-15, when the bot began both OBEYING the window (synthetic_user._entry_breach skips an out-of-window pick, and records the skip so the metric cannot go quiet) and buying punctually at 08:00 ET. Before that it bought 4-6 h late, so this fill measured its own execution lag as much as the engine's levels. Do NOT widen formatters.entry_window_pct 'to match measured reality' — proposed, investigated and rejected 2026-09-13: it would legitimise the bad fill and weaken a published promise.

</details>

### [DECIDED] [TECHNICAL BUG] DOT filled 11.22% outside the published entry window  *(n=121)*

`entry_window/DOT/2026-09-08` · **acknowledged**, open 17d
...
**Evidence:** The morning message promises "enter within X% — skip if above". DOT filled 11.22% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 121 observations breach (8.3%).
...
`integrity/638eb7bc69ed` · **acknowledged**, open 33d
...
`integrity/425fd0b45bd0` · **acknowledged**, open 33d
...
### [MEASURE] [METRIC] Stop distance distribution  *(n=146)*

**Evidence:** median 5.0% across 146 positions; 0 below the 3.0% threshold.
...
### [MEASURE] [METRIC] Synthetic trader's book vs its SPY twin (identical cash flows)  *(n=4)*
...
**Evidence:** bot $9,945.88 (-0.54%) vs SPY twin $9,979.51 (-0.20%) on identical cash flows since 2026-09-20 · 4 trading day(s) · alpha -0.34 pts · max drawdown bot 1.45% / twin 0.53% · 8 buys, 1 sells · only 4 trading day(s) — directional, not conclusive
...
### [MEASURE] [METRIC] Pick ledger has cleared the honesty gate  *(n=99)*

**Evidence:** 99 matured picks (gate 30).
