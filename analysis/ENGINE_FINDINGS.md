...
*Regenerated 2026-09-15 00:25 UTC by `scripts/analyze_engine.py`. Read this at the START of a session and work the open findings.*
...
### [ACT] [TECHNICAL BUG] NVDA filled 8.98% outside the published entry window  *(n=99)*

`entry_window/NVDA/2026-08-27` · **acknowledged**, open 18d
...
**Evidence:** The morning message promises "enter within X% — skip if above". NVDA filled 8.98% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 99 observations breach (10.1%).
...
### [ACT] [TECHNICAL BUG] AMZN filled 4.0% outside the published entry window  *(n=99)*

`entry_window/AMZN/2026-08-28` · **acknowledged**, open 17d
...
**Evidence:** The morning message promises "enter within X% — skip if above". AMZN filled 4.0% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 99 observations breach (10.1%).

**Fix:** This is a TRUST defect, not a performance one. Either widen the published window in formatters.entry_window_pct to match measured reality, or make agent._build_premarket_gap_warnings warn on the gap. Do NOT re-hardcode 2 or 3 — that constant is the ONE definition and it has drifted before.

</details>

### [ACT] [TECHNICAL BUG] NOW filled 2.68% outside the published entry window  *(n=99)*

`entry_window/NOW/2026-08-31` · **acknowledged**, open 14d
...
**Evidence:** The morning message promises "enter within X% — skip if above". NOW filled 2.68% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 99 observations breach (10.1%).

**Fix:** This is a TRUST defect, not a performance one. Either widen the published window in formatters.entry_window_pct to match measured reality, or make agent._build_premarket_gap_warnings warn on the gap. Do NOT re-hardcode 2 or 3 — that constant is the ONE definition and it has drifted before.

</details>

### [ACT] [TECHNICAL BUG] MMED filled 5.74% outside the published entry window  *(n=99)*

`entry_window/MMED/2026-09-02` · **acknowledged**, open 13d
...
**Evidence:** The morning message promises "enter within X% — skip if above". MMED filled 5.74% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 99 observations breach (10.1%).

**Fix:** This is a TRUST defect, not a performance one. Either widen the published window in formatters.entry_window_pct to match measured reality, or make agent._build_premarket_gap_warnings warn on the gap. Do NOT re-hardcode 2 or 3 — that constant is the ONE definition and it has drifted before.

</details>

### [ACT] [TECHNICAL BUG] DOT filled 11.22% outside the published entry window  *(n=99)*

`entry_window/DOT/2026-09-08` · **acknowledged**, open 7d
...
**Evidence:** The morning message promises "enter within X% — skip if above". DOT filled 11.22% above, so a user who OBEYED the instruction would have skipped a pick the bot bought. 10 of 99 observations breach (10.1%).
...
`integrity/638eb7bc69ed` · **acknowledged**, open 23d
...
`integrity/425fd0b45bd0` · **acknowledged**, open 23d
...
### [MEASURE] [METRIC] Stop distance distribution  *(n=120)*

**Evidence:** median 5.0% across 120 positions; 0 below the 3.0% threshold.
